    ...
    return (
        <Formik
            ...
            validationSchema={object().shape({
                term: string().min(3, 'Por favor ingrese al menos tres caracteres para iniciar la búsqueda.'),
            })}
                ...
                <Modal {...props}>
                    <Form>
                        <FormikFieldWrapper
                            name={'term'}
                            label={'Buscar...'}
                            description={'Ingrese un nombre de servidor, UUID o asignación para comenzar a buscar.'}
                        >
                            <SearchWatcher />
